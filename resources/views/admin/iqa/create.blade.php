            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="text-center mb-5">
                        <h3><u>Add Question with Answer</u></h3>
                    </div>
                    <form action="{{ route('iqa.store') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control @error('language') is-invalid @enderror"
                                    ...
                                    placeholder="Enter  Language Name" value="{{ old('language') }}" required>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control @error('heading') is-invalid @enderror"
                                    ...
                                    placeholder="Enter  Heading" value="{{ old('heading') }}" required>
    ...
    margin-top: -1.3rem;">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <textarea class="form-control @error('question') is-invalid @enderror" id="question" style="width: 100%; height: 50px;"
                                    name="question" placeholder="Enter  Question" value="{{ old('question') }}" required> Enter question</textarea>
                                @error('question')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <textarea class="form-control @error('quote') is-invalid @enderror" id="quote" style="width: 100%; height: 50px;"
                                    name="quote" placeholder="Enter Quote" value="{{ old('description') }}" required> Enter quote</textarea>
                                @error('quote')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea class="form-control @error('answer') is-invalid @enderror" id="answer" style="width: 100%; height: 90px;"
                                    name="answer" placeholder="Enter  Answer" value="{{ old('answer') }}" required>Enter answer </textarea>
                                @error('answer')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea class="form-control @error('code_block') is-invalid @enderror" id="code_block"
                                    style="width: 100%; height: 90px;" name="code_block" placeholder="Enter Code" value="{{ old('code_block') }}"
                                    required>Enter realted code </textarea>
                                @error('code_block')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
